            ...
            <table className="min-w-full text-left border-collapse bg-white">
              ...
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  ...
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm w-3/8">Paradigma Sistem Ekosistem Awan (Cloud)</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm w-3/8">Paradigma Infrastruktur Lokal Fog/Edge (Kabut/Tepi)</th>
                </tr>
              </thead>
              ...
              <tbody className="text-gray-700 text-sm">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Lokasi Pusat Fasilitas</td>
                  <td className="py-4 px-6 border-b border-gray-100">Memusatkan fasilitas infrastruktur server berukuran raksasa pada instalasi titik simpul strategis berposisi sentralistik jaringan arsitektur global.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menyebarluaskan kekuatan mesin analitik ukuran sirkuit lokal fungsionalitasnya persis menempel pada area perbatasan tepi lokasi operasi benda objek luar jaringan pinggiran.</td>
                </tr>
                {/* Baris 2 */}
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Ambang Keterlambatan Tunda Transmisi (Latensi)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Toleransi ketidakpastian tinggi akibat transmisi jauh lintas benua yang merentang di zona kelambatan sangat parah.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Kecepatan aksi respons deterministik instan yang dipukul konstan amat sangat rendah sekali (milidetik).</td>
                </tr>
                {/* Baris 3 */}
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Dukungan Mobilitas Pergerakan Perangkat</td>
                  <td className="py-4 px-6 border-b border-gray-100">Secara arsitektur tidak diaplikasikan karena letak komputasi jauh serta terikat topologi fisik pelayan statis.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Sangat adaptif dan melayani dinamika perpindahan aset benda aktif yang berpindah titik operasi area dinamis.</td>
                </tr>
                {/* Baris 4 */}
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Spesialisasi Fungsi dan Pengolahan Logikal</td>
                  <td className="py-4 px-6 border-b border-gray-100">Superior dalam manajemen rekaman historis analitis panjang dan penguasaan pergerakan model AI kelas berat yang mutlak menjamin koneksi kualitas tinggi konstan.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Lincah dan gesit menanggapi impuls sinyal elektronik reaktif seketika murni dalam hitungan milidetik sehingga mesin dapat mengeksekusi pemutusan sirkuit instan.</td>
                </tr>
              </tbody>
            </table>
          </div>
