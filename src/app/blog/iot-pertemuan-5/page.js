    ...
    <main className="min-h-screen bg-white text-black font-sans antialiased">
      ...
      <section className="pt-32 px-4 max-w-3xl mx-auto pb-24">
        ...
        <article className="prose prose-lg prose-gray max-w-none text-gray-700">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">1. Pendahuluan: Transformasi Digital dan Konsepsi Dasar Internet of Things</h2>
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">2. Blok Sektor Fundamental Pembentuk Ekosistem IoT</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">3. Arsitektur ETSI: Revolusi Virtualisasi Fungsi Jaringan (NFV)</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">3.1. Lanskap Ekosistem Sumber Terbuka dalam Orkestrasi NFV</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">3.2. Komposisi Lapisan Komputasi Arsitektur NFV</h3>
          <p className="mb-6 leading-relaxed">
            ...
            <table className="min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Entitas Lapisan Abstraksi NFV</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Komponen Spesifik</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Penjabaran Operasional dan Implikasi</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">VNF (Virtualized Network Functions)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Koleksi Virtual Functions</td>
                  <td className="py-4 px-6 border-b border-gray-100">Perangkat lunak yang berfungsi menggantikan entitas keras fisik. Berbagai layanan jaringan seperti DNS, Firewall, atau IoT Packet Gateway dijalankan sebagai VNF di atas lapisan penyelia (hypervisor). Fleksibilitas VNF memungkinkan replikasi layanan IoT dalam hitungan detik untuk merespons fluktuasi beban data sensor.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">NFVI (NFV Infrastructure)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Hardware Resources & Virtual Layer</td>
                  <td className="py-4 px-6 border-b border-gray-100">Merepresentasikan infrastruktur mentah di bawah VNF. Terdiri dari Compute (prosesor), Storage (media simpan), dan Network (koneksi) fisik, yang kemudian diabstraksi oleh lapisan virtualisasi (Virtualization Layer) untuk menyediakan Virtual Compute, Virtual Storage, dan Virtual Network.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900" rowSpan="3">NFV MANO (Management and Orchestration)</td>
                  <td className="py-4 px-6 border-b border-gray-100">NFV Orchestrator (NFVO)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Blok logis yang memegang tanggung jawab makro untuk melakukan inisiasi pengerahan layanan baru, mengevaluasi sumber daya tersedia, dan mengatur kebijakan jaringan lintas platform cloud.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100">VNF Manager (VNFM)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Komponen administratif yang memfokuskan kinerjanya pada manajemen siklus hidup harian untuk sebuah fungsi perangkat lunak VNF tertentu, termasuk tugas-tugas penskalaan elastis (scale-in/scale-out) dari instansiasi perangkat.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100">Virtualized Infrastructure Manager (VIM)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Lapisan kontrol yang bertugas langsung untuk mengatur dan mengeksekusi operasi infrastruktur perangkat keras dan virtualisasi di tingkat paling bawah sistem Data Center.</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">4. Model Referensi Arsitektural Sektor ITU-T</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">4.1. Empat Peringkat Lapisan Fungsional</h3>
          <p className="mb-6 leading-relaxed">Susunan dari fondasi operasional menuju integrasi logika bisnis disusun sebagai berikut:</p>
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">4.2. Kapabilitas Pilar Lintas-Lapisan (Vertikal)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">5. Standarisasi Visi Fungsional Enterprise: IoT World Forum (IWF)</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">6. Kerangka Kerja Tata Pamong Protokol Komunikasi IETF</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">6.1. Manajemen Ruang Pengalamatan Multikast dan Jaringan Privat</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">6.2. Komputasi Tanpa Intervensi M2M pada Perangkat Terkendala</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">6.3. Dinamika Tim Kerja Fungsional dan Sinkronisasi SDOs</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">6.4. Peran Kritis Integrasi Direktorat IoT IETF</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">7. Evaluasi Komparasi Lanskap Arsitektur Konseptual</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-8 rounded-lg border border-gray-200">
            <table className="min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Dewan Standarisasi Tata Kelola Ekosistem Otomasi</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Referensi Produk Rancangan Dasar & Paradigma Spesifik</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Area Pusat Pengerahan Domain Standarisasi Inovatif</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Kegunaan Utama Manfaat Praktis Sistem Skalabilitas Operasional Jaringan Korporasi</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Konsorsium ETSI (European Telecommunications Standards Institute)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Kerangka kerja Network Functions Virtualization (NFV)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Lapisan virtualisasi komputasi peranti keras (hardware infrastructure virtualization), orkestrasi perutean fungsi bandwidth elastis dari Data Center ke gawai konsumen lapangan.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menggantikan kebergantungan perangkat peladen tertutup ke wujud perangkat lunak perutean abstrak (VNF, NFVI, MANO). Menurunkan biaya belanja infrastruktur secara masif di lini penyedia operator; mempercepat adaptasi skalabilitas perutean lalu lintas koneksi secara luwes (agile scaling) memanfaatkan dukungan platform terbuka.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Sektor Standarisasi ITU-T (International Telecommunication Union)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Desain Abstraksi Fungsional Model Referensi (Dokumen rujukan Y.4000/Y.2060)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Titik fokus infrastruktur model perantara fisik transmisi (Device layer), standar sinkronisasi pelapisan perantara konversi data gerbang lokal (Gateways protocol translation), serta perlindungan kerahasiaan user end-to-end.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Memberikan rujukan kerangka operasional fundamental berlapis disokong perlindungan mandat sistem administrasi utuh seperti fungsi pencegahan network overflow, perlindungan autentikasi gerbang, integritas checksum transmisi data berantai, sampai kontrol penyandian kriptografis tertutup.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Komite Industri IWF (IoT World Forum)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Cetak Biru Basis Panduan IWF Reference Model (Inisiatif Publikasi Oktober 2014)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Ranah vertikal puncak arsitektur pengolahan fungsional informasi besar (Enterprise Big Data Middleware), perancangan logika tatanan rekayasa sistem pemograman manajemen perangkat utilitas tingkat korporasi peladen industri strategis.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mengkomplemen serta melanjutkan estafet referensi perangkat gerbang fungsional transmisi bit analog dari ITU-T menjadi platform operasional logika perancangan bisnis terpadu; menjembatani celah integrasi fungsional analitik real-time sistem perusahaan dengan ekosistem sensor keras di perbatasan.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Manajemen IETF (Internet Engineering Task Force) Bersama Komite IANA</td>
                  <td className="py-4 px-6 border-b border-gray-100">Regulasi Rekayasa Standar Protokol Transmisi Komunikasi Mesin (Networking protocols standardizations) TCP/IP khusus entitas terhubung dinamis</td>
                  <td className="py-4 px-6 border-b border-gray-100">Tata kelola registrasi matriks distribusi alamat publik Internet Protocol ruang tertutup (Private/Special Purpose IPs), restrukturisasi standardisasi tata bahasa kompresi transmisi packet header gawai mekanik.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mewadahi rute perambanan lalu lintas paket data serentak (multicast traffic distribution) dan ruang interaksi terisolasi miliaran perangkat Private networks, yang diorkestrasi oleh satu pusat dewan tata laksana teknis internal penasihat lintas disiplin terpadu.</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">8. Kesimpulan Deskriptif dan Outlook Teknologi Masa Depan</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-black mb-6">9. Karya yang dikutip</h2>
