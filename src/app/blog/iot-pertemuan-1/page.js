...
export default function IOTPertemuan1() {
  return (
    <main className="min-h-screen bg-white text-black font-sans antialiased">
      ...
      {/* Menyesuaikan padding atas/bawah agar lebih ringkas di HP */}
      <section className="pt-24 md:pt-32 px-4 md:px-6 max-w-3xl mx-auto pb-16 md:pb-24">
        ...
        {/* Judul Artikel: Skala font lebih halus (text-2xl -> sm:text-3xl -> md:text-4xl) */}
        ...
        {/* Kotak Identitas Mahasiswa: Padding disesuaikan untuk HP (p-4) dan Laptop (md:p-6) */}
        ...
        {/* Menggunakan text-base untuk HP dan text-lg untuk layar yang lebih besar */}
        <article className="prose prose-base md:prose-lg prose-gray max-w-none text-gray-700 text-base md:text-lg">
          
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-6 md:mt-8">I. LATAR BELAKANG DAN DIMENSI KONSEPTUAL INTERNET OF THINGS</h2>
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">
          ...
          {/* Menambahkan min-w-[600px] md:min-w-full pada table agar tidak mengkerut berantakan di HP, melainkan memunculkan scroll */}
            ...
            <table className="min-w-[700px] lg:min-w-full text-left border-collapse bg-white">
              ...
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-1/4">Parameter Demarkasi Teknis</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-3/8">Struktur Komunikasi Machine-To-Machine (M2M)</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-3/8">Ekosistem Internet of Things (IoT)</th>
                </tr>
              </thead>
              ...
              <tbody className="text-gray-700 text-xs md:text-sm">
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Topologi Jaringan Komunikasi</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Dirancang untuk beroperasi di sirkuit tertutup menggunakan jalur kabel tembaga serial fisik berdedikasi atau jaringan frekuensi transmisi seluler (GSM/CDMA/LTE) berpemilik khusus.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Mutlak mengandalkan infrastruktur berbasis Internet Protocol (IP) nirkabel berkapasitas besar (Wi-Fi publik, 5G, pita lebar jaringan seluler).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Ketergantungan Infrastruktur Media Transmisi</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Terbatas pada mesin-mesin yang terhubung langsung melalui kabel fisik atau jaringan lokal.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Infrastruktur jaringan cerdas yang ada di mana-mana (ubiquitous) dan dapat diskalakan tanpa batas.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Orientasi dan Fungsionalitas Ekstrasi Data</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Difokuskan pada transmisi raw data (angka pengukuran mentah fungsional). Data digunakan untuk memicu instruksi sekuensial dasar bagi mesin lain demi kelancaran operasional (otomatisasi mekanis tunggal).</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Ditunjukkan pada Integrasi penambangan Big Data. Mesin analitik menggunakan data dari seluruh elemen geografis untuk ekstraksi wawasan prediktif, pemodelan bisnis, serta manajemen strategis tingkat perusahaan.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Integrasi Eksternal dan Skalabilitas Node</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Ekspansi arsitektur sistem M2M tergolong statis dan kaku. Penambahan perangkat unit mesin M2M baru membutuhkan konfigurasi fisik yang ekstensif dan modifikasi perangkat keras system induk penerima.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Sangat terbuka secara Bawaan (Highly Scalable). Integrasi perangkat antarmuka baru bersifat fleksibel (plug-and-play) karena mengandalkan antarmuka Bahasa pemrograman perangkat lunak open architecture API standar.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Antarmuka Intervensi Manusia (User Interface)</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Sangat minimal. Antarmuka layar fisik terbatas, umumnya hanya Dikonsumsi untuk keperluan pemeliharaan dan inspeksi lokal yang diwajibkan oleh teknisi perawatan pabrik.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Menjadi nilai jual utama. Menawarkan visibilitas operasional komprehensif lewat dasbor integrasi visual aplikasi seluler canggih dan portal situs perusahaan jarak jauh kepada manajemen korporat tertinggi.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Batasan Sektor Implementasi (Orientasi Industri)</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Bersifat sangat Vertikal. Dibuat khusus untuk menyelesaikan scenario masalah singular di ranah industri spesifik, seperti pembacaan sistem meteran air pintar di utilitas kota saja.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Bersifat masif Horizontal. Mengawinkan solusi di berbagai disiplin bidang, mampu menjalin interaksi antara pengukur kelembaban ladang pertanian dengan sistem logistik gudang pemasok pangan secara simultan.</td>
                </tr>
