    ...
    <main className="min-h-screen bg-white text-black font-sans antialiased">
      ...
      <section className="pt-24 md:pt-32 px-4 md:px-6 max-w-3xl mx-auto pb-16 md:pb-24">
        ...
        <article className="prose prose-base md:prose-lg prose-gray max-w-none text-gray-700 text-base md:text-lg">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-6 md:mt-8">1. PENDAHULUAN DAN LATAR BELAKANG</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">2. MODEL REFERENSI IOT: FONDASI STANDARISASI GLOBAL (ISO/IEC 30141)</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">3. MODEL DOMAIN IOT: PEMETAAN ENTITAS FISIK DAN REPRESENTASI VIRTUAL</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">3.1. Studi Kasus: Spesifikasi Model Domain pada Sistem Pengobatan Pintar</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">4. MODEL INFORMASI IOT: ABSTRAKSI KONEKTIVITAS DAN PERAN GERBANG INTEGRASI</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">4.1. Spektrum Penerapan Vertikal Berdasarkan Model Informasi</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
            ...
            <table className="min-w-[600px] lg:min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-1/4">Vertikal Industri IoT</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm auto">Fokus dan Contoh Penerapan Fungsional</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-xs md:text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Consumer & Home</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Difokuskan pada kenyamanan gaya hidup personal, manajemen efisiensi energi residensial, dan otomasi peralatan elektronik rumah tangga harian.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Retail</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Optimasi visibilitas rantai pasok secara real-time, manajemen inventaris rak otomatis berbasis sensor, serta analitik perilaku dan pola pergerakan konsumen di dalam lorong toko fisik.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Security & Surveillance</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Pemantauan keamanan waktu nyata non-stop menggunakan jaringan sensor inframerah perimeter, sistem kamera pintar pengenalan pola, dan deteksi intrusi anomali.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Industrial IoT (IIoT)</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Utilisasi sensor getaran untuk pemeliharaan prediktif pada mesin berat, optimasi lini perakitan pabrik, serta pelacakan aset logistik dinamis di lingkungan manufaktur.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Transportation</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Meliputi sistem telematika manajemen armada komersial, optimasi rute lalu lintas logistik secara proaktif, dan fondasi penggerak navigasi kendaraan otonom.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Smart Infrastructure</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Integrasi berskala kota makro untuk tata kelola lampu jalan responsif, efisiensi distribusi air bersih, manajemen tata ruang limbah, hingga sistem pengaturan lampu lalu lintas cerdas.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Healthcare</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Pemantauan kondisi vital pasien secara remote, sistem manajemen aset perangkat medis di fasilitas rumah sakit, dan presisi diagnostik melalui pengumpulan data biometrik secara berkesinambungan.</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">5. MODEL FUNGSIONAL IOT DAN INTEGRASINYA DALAM REVOLUSI INDUSTRI 4.0</h2>
          
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">5.1. Anatomi Fungsional Perangkat Keras IoT</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">5.2. Konteks Historis: Peta Jalan Menuju Revolusi Industri 4.0</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">6. EKSPLORASI LIMA PILAR UTAMA TEKNOLOGI INDUSTRI 4.0</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">6.1. Pilar Pertama: Internet of Things (IoT) sebagai Saraf Sensorik</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">6.2. Pilar Kedua: Big Data sebagai Penambang Wawasan Eksekutif</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">6.3. Pilar Ketiga: Artificial Intelligence (AI) sebagai Kognisi Otomasi</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">6.4. Pilar Keempat: Cloud Computing (Komputasi Awan)</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">6.5. Pilar Kelima: Additive Manufacturing (Manufaktur Aditif)</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-8 rounded-lg border border-gray-200 shadow-sm">
            <table className="min-w-[600px] lg:min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm">Parameter Evaluasi Operasional</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm">Paradigma Manufaktur Aditif (Contoh: 3D Printing, SLS, DMLS)</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm">Paradigma Manufaktur Konvensional (Contoh: CNC Milling, Casting)</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-xs md:text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Prinsip Konstruksi Dasar</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Menambahkan dan menyatukan partikel material secara berurutan, lapis demi lapis.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Memotong dan mengikis (CNC) atau menuangkan cairan ke cetakan solid (Casting).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Tingkat Kompleksitas Desain Geometri</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Tingkat fleksibilitas sangat tinggi tak terbatas. Mampu memfabrikasi arsitektur rongga internal bersarang dan desain mekanikal rumit.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Modul desain sangat terkekang oleh sudut batas jangkauan pisau pahat (CNC) atau keterbatasan demensi pola dasar (Casting).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Tingkat Residu Pemborosan Limbah Material</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Amat sangat rendah dan berwawasan pelestarian lingkungan. Nosel hanya menempatkan polimer di sektor geometri yang krusial.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Pemborosan limbah sedang hingga sangat tinggi akibat proses permesinan yang memproduksi sisa tatal logam berlebih.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Beban Pembiayaan Perkakas Dasar (Tooling)</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Tidak menuntut fabrikasi mold atau dudukan penahan (Zero Tooling), pengeluaran awal sangat murah.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Memerlukan belanja investasi pembuatan pola mold baja atau set alat potong khusus untuk setiap pergantian produk.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Fokus Optimalitas Segmentasi Skala Fabrikasi</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Superior untuk penyusunan prototyping kilat, manufaktur suku cadang unit volume batch kecil kustom.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Unggul di ranah manufaktur pencetakan massal komoditas volume raksasa seragam identik berkecepatan tinggi.</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">7. MODEL KOMUNIKASI IOT: ARSITEKTUR SINKRONISASI PERTUKARAN INFORMASI</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">7.1. Mekanisme Push Data (Transmisi Inisiatif Sensorik Aktif)</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h3 className="text-lg md:text-xl font-bold text-black mb-3 md:mb-4 mt-6">7.2. Mekanisme Get Data (Transmisi Sinkronisasi Tarik Aplikasi Klien)</h3>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">8. MODEL KEAMANAN IOT: PEMETAAN PERLINDUNGAN SPEKTRUM EKOSISTEM SIBER TERIDSTRIBUSI</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-8 rounded-lg border border-gray-200 shadow-sm">
            <table className="min-w-[600px] lg:min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-1/4">Dimensi Vertikal Operasional Industri</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm auto">Fokus Utama Sasaran Analisis Perlindungan Ekosistem Keamanan Siber IoT</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-xs md:text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Mobile Devices & Computing Media</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Pembentengan akses protektif komprehensif atas modul piranti keras dan otorisasi kredensial pengguna dari malware maupun pencurian informasi awan lokal internal.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Smart Meters & Smart Energy</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Implementasi autentikasi pertukaran enkripsi protokol agar jaringan utilitas energi terhindar dari intrik pencurian bypass penggelapan perhitungan tagihan listrik.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Connected Home & Consumer Electronics</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Proteksi data privasi aktivitas sistem otomasi melalui pembaharuan celah kerentanan tambalan firmware Over-The-Air (OTA) dari penyadapan akses hacker.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Wearables & Medical</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Melindungi transmisi sensor riwayat biometrik rekam medis kelainan klinis serta menghentikan serangan injeksi manipulatif jarak jauh mematikan pada perangkat mesin pacu jantung nirkabel.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Automotive, Aerospace, and Defense</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Penjaminan arsitektur latensi keselamatan siber nir-henti bagi kemudi kendaraan otonom, otomasi kokpit radar pesawat, navigasi peluncur balistik pertahanan dirgantara, dan satelit intelijen ruang angkasa.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Networking & Wireless Infrastructure</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Eskalasi perutean pemancar infrastruktur BTS telekomunikasi, membungkus ketat pertukaran spektrum melalui penyandian kriptografi TLS/SSL untuk mengamankan rahasia kanal udara dari penyusup.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Industrial & Machine-to-Machine (M2M)</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Isolasi logikal segmentasi batasan sinkronisasi di inti mesin SCADA jaringan manufaktur hulu raksasa demi meyakinkan konveyor tetap tangguh dari bombardir kelumpuhan badai siber DDoS destruktif.</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-8 md:mt-10">9. KESIMPULAN</h2>
          <p className="mb-4 md:mb-6 leading-relaxed">
          ...
          <div className="mt-12 md:mt-16 pt-6 md:pt-8 border-t border-gray-200">
            <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6">10. SUMBER REFERENSI</h2>
