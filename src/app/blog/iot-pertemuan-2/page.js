    ...
    <main className="min-h-screen bg-white text-black font-sans antialiased">
      ...
      <section className="pt-24 md:pt-32 px-4 md:px-6 max-w-3xl mx-auto pb-16 md:pb-24">
        ...
        <article className="prose prose-base md:prose-lg prose-gray max-w-none text-gray-700 text-base md:text-lg">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-black mb-4 md:mb-6 mt-6 md:mt-8">I. Pendahuluan: Perubahan Konektivitas di Era Digital</h2>
            ...
            <table className="min-w-[600px] lg:min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  ...
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-3/8">Tradisi Telefoni Seluler (Model B2C)</th>
                  <th className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-200 font-semibold text-xs md:text-sm w-3/8">Penyedia Layanan M2M & IoT (Model B2B2C)</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-xs md:text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Alur Rantai Nilai</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Operator Seluler → Konsumen Akhir.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Operator Seluler → Sektor Industri Manufaktur/Jasa → Konsumen Akhir.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Bentuk Komoditas yang Dijual</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Layanan dasar seperti menit panggilan suara dan paket kuota data seluler.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Solusi perangkat fisik terhubung (connected devices) yang telah disematkan sistem layanan jaringan.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Peran Sentral Industri Menengah</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Tidak ada perantara industry spesifik; konektivitas bersifat langsung ke gawai personal.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Sektor industri (misal: pabrikan mobil, rumah sakit) membeli konektivitas untuk diintegrasikan ke dalam produk mereka.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100 font-medium text-gray-900">Keterlibatan Layanan Tambahan</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Sangat minimal, umumnya terbatas pada fitur dasar operator seluler.</td>
                  <td className="py-3 px-4 md:py-4 md:px-6 border-b border-gray-100">Sangat dominan; mencakup telematika, pemantauan analitik pintar, asuransi, dan manajemen signage digital berbasis CRM kuat.</td>
                </tr>                
              </tbody>
            </table>
          </div>
