    ...
    <main className="min-h-screen bg-white text-black font-sans antialiased">
      ...
      <section className="pt-32 px-4 max-w-3xl mx-auto pb-24">
        ...
        <article className="prose prose-lg prose-gray max-w-none text-gray-700">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">1. Pendahuluan dan Latar Belakang Evolusi IoT</h2>
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">2. Sembilan Komponen Dasar Ekosistem Internet of Things</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.1. Perangkat Fisik dan Aktuator (Things)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.2. Gerbang Konektivitas Lapangan (Gateways)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.3. Gerbang Komputasi Awan (Cloud Gateway)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.4. Prosesor Aliran Data (Streaming Data Processor)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.5. Danau Data (Data Lake)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.6. Gudang Data Besar (Big Data Warehouse)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.7. Analisis Data (Data Analytics)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.8. Pembelajaran Mesin dan Pembuatan Model ML (Machine Learning)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">2.9. Aplikasi Pengguna (User Applications)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-8 mt-6 rounded-lg border border-gray-200">
            <table className="min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Klasifikasi Lapisan</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Komponen IoT</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Peran Spesifik dalam Ekosistem</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Karakteristik Data</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Lapisan Fisik & Ujung</td>
                  <td className="py-4 px-6 border-b border-gray-100">Things (Sensor & Aktuator)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mengumpulkan parameter lingkungan dan mengeksekusi tindakan fisik.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Data analog, mentah, bervolume masif.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100"></td>
                  <td className="py-4 px-6 border-b border-gray-100">Gateways (Gerbang Lapangan)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menyaring, mengurangi volume data, dan menjadi perantara transmisi dari benda ke cloud.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Data awal yang telah difilter.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Lapisan Transmisi Awan</td>
                  <td className="py-4 px-6 border-b border-gray-100">Cloud Gateway</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mengompresi transmisi aman, dan memediasi kesesuaian berbagai protokol komunikasi gateway lapangan.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Paket komunikasi jaringan yang terenkripsi.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100"></td>
                  <td className="py-4 px-6 border-b border-gray-100">Streaming Data Processor</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mencegah kerusakan transmisi serta memastikan kelancaran arus menuju danau data.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Aliran informasi (streaming).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Lapisan Penyimpanan Pusat</td>
                  <td className="py-4 px-6 border-b border-gray-100">Data Lake (Danau Data)</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menampung total aliran data dari berbagai perangkat dalam bentuk tumpukan murni tak terstruktur.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Data mentah berformat alaminya (himpunan/aliran).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100"></td>
                  <td className="py-4 px-6 border-b border-gray-100">Big Data Warehouse</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menyimpan hanya data terstruktur, telah dibersihkan, dan menyertakan rekaman informasi konteks/lokasi perangkat.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Data matang yang bersih dan berelasi.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Lapisan Pemrosesan Analitik</td>
                  <td className="py-4 px-6 border-b border-gray-100">Data Analytics</td>
                  <td className="py-4 px-6 border-b border-gray-100">Membuka wawasan tersembunyi, menemukan inefisiensi operasional, dan menampilkan visualisasi metrik (diagram/skema).</td>
                  <td className="py-4 px-6 border-b border-gray-100">Kesimpulan wawasan (actionable insight).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100"></td>
                  <td className="py-4 px-6 border-b border-gray-100">Machine Learning</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mengevaluasi histori dari warehouse untuk merumuskan dan memperbarui algoritma control prediktif secara reguler.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Model logika, algoritma kontrol.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Lapisan Antarmuka</td>
                  <td className="py-4 px-6 border-b border-gray-100">User Applications</td>
                  <td className="py-4 px-6 border-b border-gray-100">Platform sentuh manusia (web/ponsel) untuk monitoring proaktif, mengirim instruksi manual, serta mengatur skema otomasi mandiri.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Antarmuka pengguna grafis (GUI) dan notifikasi.</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-2xl font-bold text-black mb-6 mt-8">3. Arsitektur Jaringan dan Referensi Model Transmisi Data</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">3.1. Konsep Manajemen Aliran Informasi (Vanderminden, 2016)</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">4. Orkestrasi Proses Bisnis dalam Ekosistem IoT</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">4.1. Struktur Alur Bisnis dan Integrasi Multipihak</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h4 className="text-lg font-bold text-black mb-2 mt-4">A. Device Management (Manajemen Perangkat)</h4>
          <p className="mb-6 leading-relaxed">
          ...
          <h4 className="text-lg font-bold text-black mb-2 mt-4">B. Data Routing (Perutean Lalu Lintas Data)</h4>
          <p className="mb-6 leading-relaxed">
          ...
          <h4 className="text-lg font-bold text-black mb-2 mt-4">C. Subscriber Management (Manajemen Pelanggan)</h4>
          <p className="mb-6 leading-relaxed">
          ...
          <h4 className="text-lg font-bold text-black mb-2 mt-4">D. Billing / Rating (Subsistem Penagihan Keuangan)</h4>
          <p className="mb-6 leading-relaxed">
          ...
          <div className="overflow-x-auto mb-8 mt-6 rounded-lg border border-gray-200">
            <table className="min-w-full text-left border-collapse bg-white">
              <thead>
                <tr className="bg-gray-50 text-gray-900">
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Komponen Alur Bisnis</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Deskripsi Fungsi dan Peran Integratif</th>
                  <th className="py-4 px-6 border-b border-gray-200 font-semibold text-sm">Tujuan Operasional Komersial</th>
                </tr>
              </thead>
              <tbody className="text-gray-700 text-sm">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Mobile Network Operator</td>
                  <td className="py-4 px-6 border-b border-gray-100">Penyedia layanan tulang punggung jaringan nirkabel makro (GPRS, 4G, NB-IoT).</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menjamin visibilitas perangkat tanpa bergantung pada kabel LAN lokal.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Platform Inti</td>
                  <td className="py-4 px-6 border-b border-gray-100">Sistem Middleware pusat penyedia kapabilitas orkestrasi pemrosesan cloud.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Sentralisasi semua lalu lintas sistem perangkat keras dan logika operasi.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Partners</td>
                  <td className="py-4 px-6 border-b border-gray-100">Keterlibatan manufaktur eksternal atau penyedia aplikasi spesifik pendukung melalui API.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mengayakan fitur ekosistem dengan integrasi plug-and-play multi-vendor.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Device Management</td>
                  <td className="py-4 px-6 border-b border-gray-100">Fungsi diagnostik, pemantauan status kesehatan mesin jarak jauh, perlindungan (update).</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menjamin kelangsungan operasi jutaan mesin tersebar tanpa kunjungan lapangan manual.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Data Routing</td>
                  <td className="py-4 px-6 border-b border-gray-100">Algoritma perutean arus pengalihan parameter data ke tujuan aplikasi spesifik/server relevan.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Mengelola efisiensi bandwidth cloud perusahaan untuk menghindari beban macet.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Subscriber Management</td>
                  <td className="py-4 px-6 border-b border-gray-100">Pengaturan repositori entitas identitas, kontrol batasan fasilitas hak (rights), registrasi unit berlangganan klien.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Peningkatan layanan pengalaman profil klien serta menjaga kerahasiaan kepemilikan alat (Privasi).</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Billing / Rating</td>
                  <td className="py-4 px-6 border-b border-gray-100">Algoritma metrik penerjemahan volume kuota transmisi bit maupun lisensi operasional aplikasi pelanggan terhadap tagihan biaya uang.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Terciptanya sistem monetisasi atau pengembalian investasi operasional yang dapat diandalkan secara otomasi bulanan.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">API</td>
                  <td className="py-4 px-6 border-b border-gray-100">Perantara integrasi bahasa mesin standar antar gateway eksternal menuju core arsitektur.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Penghubung instan untuk merajut silang aplikasi dari lapisan Partner maupun internal perusahaan.</td>
                </tr>
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="py-4 px-6 border-b border-gray-100 font-medium text-gray-900">Front End</td>
                  <td className="py-4 px-6 border-b border-gray-100">Konstruksi visual dari produk UI akhir (portal aplikasi dasbor) yang terintegrasi memuat wawasan interaktif bagi end-user.</td>
                  <td className="py-4 px-6 border-b border-gray-100">Menciptakan adopsi mudah (Ease of Use) demi kemudahan kontrol visual di tangan pelanggan awam.</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-2xl font-bold text-black mb-6 mt-8">5. Evolusi Risiko Celah Keamanan dan Pengembangan Smart Cities</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">5.1. Peningkatan Tantangan Keamanan pada Interaksi Langsung Manusia-Mesin</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-bold text-black mb-4 mt-6">5.2. Kota Pintar (Smart Cities) Sebagai Perluasan Target Sasaran Cyber Tingkat Nasional</h3>
          <p className="mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-black mb-6 mt-8">6. Analisis Penutup</h2>
          <p className="mb-6 leading-relaxed">
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <h2 className="text-2xl font-bold text-black mb-6">7. Daftar Pustaka</h2>
